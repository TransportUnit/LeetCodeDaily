...
<details><summary>Hint 1</summary>For each column, find the number of consecutive ones ending at each position.</details>
<details><summary>Hint 2</summary>For each row, sort the cumulative ones in non-increasing order and "fit" the largest submatrix.</details>